    ...
    for(var i  in Bees)
    {
      ...
      {  
        ...
        if(scriptParam.badge)
        {
          ...
          $(document.body).append('<div onclick=popupPhone("'+goUrl+'") style="width:100px;height:100px;margin-top:'+TopMargin+'px;position: fixed;right:0;" ><center><img style="width:80px;height:70px;" src="'+ServerUrl+'/img/beebanner.png"></img><br><font color="red" size="2">'+Bees[position].url+'</font></center></div>');
        }
      };
